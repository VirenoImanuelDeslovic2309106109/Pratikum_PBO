...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println("10. Lihat Jumlah Transaksi Selesai");
            ...
            try {
                ...
                switch (pilihan) {
                    ...
                    case 10: {
                        System.out.println("Jumlah transaksi yang telah selesai: " + TransaksiPenyewaan.GetJumlahTransaksiSelesai());
                        break;
                    }
                ...
                System.out.println("Terjadi kesalahan input. Harap masukkan angka yang sesuai!");
